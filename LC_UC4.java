...
public class LC_UC4 {
	...
	public LC_UC4(int x, int y) {
     ...
     public static void main(String[] args) {
 		...
 		LC_UC4 point1 = new LC_UC4(Ax1,Ay1); //Object creation for point 1
		LC_UC4 point2 = new LC_UC4(Ax2,Ay2);//object creation for point 2
		...
		LC_UC4 point3 = new LC_UC4(Bx1,By1); //Object creation for point 3
		LC_UC4 point4 = new LC_UC4(Bx2,By2);//object creation for point 4
